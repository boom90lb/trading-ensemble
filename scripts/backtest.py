...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str, 
        default=None,
        help='Path to the saved model (default: latest model)'
    )
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.1,
        help='Position size as a fraction of portfolio (0-1)'
    )
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.02,
        help='Stop loss as a fraction of entry price (0-1)'
    )
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.05,
        help='Take profit as a fraction of entry price (0-1)'
    )
    ...
    parser.add_argument(
        '--use_ppo', 
        action='store_true',
        help='Use LSTM-PPO model for trading decisions'
    )
